...
# Bare VLLM_* names belong to vLLM itself and are not APIPod configuration.
VLLM_HOST = environ.get("APIPOD_VLLM_HOST", "127.0.0.1")
VLLM_PORT = int(environ.get("APIPOD_VLLM_PORT", "18000"))
VLLM_MAX_MODEL_LEN = environ.get("APIPOD_VLLM_MAX_MODEL_LEN", "")
# worker-vllm default. vLLM's own default (1024) exceeds Qwen3.8 Mamba cache.
VLLM_MAX_NUM_SEQS = environ.get("APIPOD_VLLM_MAX_NUM_SEQS", "256")
VLLM_REASONING_PARSER = environ.get("APIPOD_VLLM_REASONING_PARSER", "")
VLLM_SPECULATIVE_CONFIG = environ.get("APIPOD_VLLM_SPECULATIVE_CONFIG", "")
VLLM_EXTRA_ARGS = environ.get("APIPOD_VLLM_EXTRA_ARGS", "")
VLLM_STARTUP_TIMEOUT = int(environ.get("APIPOD_VLLM_STARTUP_TIMEOUT", "1200"))
